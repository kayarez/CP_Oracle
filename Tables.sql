...
CREATE TABLE Trains (
	...
	NumberTrain NVARCHAR2(30) NOT NULL,
...
ALTER TABLE Tickets ADD CONSTRAINT Tickets_fk1 FOREIGN KEY (OrderId) REFERENCES Orders(Id) ON DELETE CASCADE;
...
ALTER TABLE Tickets DROP CONSTRAINT Tickets_fk1;
